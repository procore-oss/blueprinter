      ...
      module Core
        ...
        class Values < Extension
          ...
          def field_value(ctx)
            ...
            ctx.value = ctx.field.value_proc ? proc_value(ctx) : data[:extractor].field(ctx)
          ...
          def object_value(ctx)
            data = ctx.store[ctx.field.object_id]
            ctx.value = ctx.field.value_proc ? proc_value(ctx) : data[:extractor].object(ctx)
          ...
          def collection_value(ctx)
            data = ctx.store[ctx.field.object_id]
            ctx.value = ctx.field.value_proc ? proc_value(ctx) : data[:extractor].collection(ctx)
