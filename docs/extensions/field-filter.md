...
This extension filters out sensitive fields based on the user's permissions. (Is this the *best* way to do that? Arguably not, but it's just an example.)
...
class ApplicationBlueprint < Blueprinter::V2::Base
  extensions << FieldFilterExtension.new([/ssn/i, /dob/i]) do
