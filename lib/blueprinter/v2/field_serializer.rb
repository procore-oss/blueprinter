    ...
    class FieldSerializer
      ...
      class Field < self
        def serialize(ctx, result)
          ...
          return if cond.exclude_field?(ctx.with_store cond) || (@run_exclude_field && hooks.any?(:exclude_field?, ctx))
      ...
      class Object < self
        ...
        def serialize(ctx, result)
          ...
          return if cond.exclude_object?(ctx.with_store cond) || (@run_exclude_object && hooks.any?(:exclude_object?, ctx))
      ...
      class Collection < self
        ...
        def serialize(ctx, result)
          ...
          return if cond.exclude_collection?(ctx.with_store cond) || (@run_exclude_collection && hooks.any?(:exclude_collection?, ctx))
