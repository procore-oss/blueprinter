...
## Extracting field values from objects
...
Return whatever you want from a block. It will be passed a context argument which contains the object being rendered, [among other things](../api/context-objects.md).
