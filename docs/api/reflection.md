...
Blueprints may be reflected on to inspect their views, fields, and associations. This is useful for building [extensions](./extensions.md), and possibly even for some applications.
