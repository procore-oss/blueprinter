...
The [field_value](../api/extensions.md#field_value), [object_value](../api/extensions.md#object_value), and [collection_value](../api/extensions.md#collection_value) extension hooks can also be used.
