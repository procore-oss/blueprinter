...
Blueprinter Legacy/V1 had a special feature for an `id` field and `identifier` view. Blueprinter V2 does not have this concept, but you can simulate it.
...
# This Blueprint will only contain the id field
class IdentifierBlueprint < ApplicationBlueprint
end
```
