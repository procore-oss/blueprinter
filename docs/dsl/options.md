...
Options that accept Procs, lambdas, or method names are usually passed a single "context object" argument. It contains the object being rendered, as well as other useful information. See the [Context Objects](../api/context-objects.md) documentation for more information.
...
_Scope:_ Field, object, collection

_Context object fields_: `blueprint`, `field`, `object`, `options`, `store`, `instances`
...
_Scope:_ Blueprint, view, partial, render
...
_Scope:_ Blueprint, view, partial, field, object, collection, render
...
_Context object fields_: `blueprint`, `field`, `value`, `object`, `options`, `store`, `instances`
...
_Scope_: Field, object, collection
...
Pass a [custom extractor](../api/extractors.md) class.

_Scope:_ Blueprint, view, partial, field, object, collection

```ruby
options[:extractor] = MyCustomExtractor
...
_Context object fields_: `blueprint`, `value`, `object`, `options`, `store`, `instances`
