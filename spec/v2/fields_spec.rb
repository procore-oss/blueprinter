...
describe "Blueprinter::V2 Fields" do
  context "fields" do
    it "adds fields with options" do
      ...
      expect(ref.fields[:name].class.name).to eq "Blueprinter::V2::Reflection::Field"
    ...
    it 'adds multiple fields' do
      ...
      expect(ref.fields[:description].class.name).to eq "Blueprinter::V2::Reflection::Field"
      expect(ref.fields[:description].name).to eq :description
      expect(ref.fields[:description].from).to eq :description
      expect(ref.fields[:description].options).to eq({})

      expect(ref.fields[:status].class.name).to eq "Blueprinter::V2::Reflection::Field"
  ...
  context "associations" do
    it "adds associations with options" do
      ...
      ref = blueprint.reflections[:default]
      expect(ref.objects[:category].class.name).to eq "Blueprinter::V2::Reflection::Object"
