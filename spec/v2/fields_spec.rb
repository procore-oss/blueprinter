...
describe "Blueprinter::V2 Fields" do
  ...
  context "associations" do
    it "should add associations with options" do
      ...
      expect(ref.associations[:category].collection).to be false
      ...
      expect(ref.associations[:widgets].collection).to be true
      ...
      expect(ref.associations[:foo].collection).to be false
    end
  end
